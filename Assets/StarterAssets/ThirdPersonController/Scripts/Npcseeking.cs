...
#endif
    public class Npcseeking : MonoBehaviour
    {
        [Header("Player")]
        ...
        private const float SeekDistance = 10.0f;
        ...
        private void Update()
        {
            ...
            if (playerTransform != null && Vector3.Distance(transform.position, playerTransform.position) < SeekDistance)
            {
                Move();
                SeekPlayer();
            }
        ...
        private void FindPlayer()
        {
            ...
            {
                Debug.LogError("Player object not found. Make sure there is an object with the tag 'Player'.");
            }
        }
